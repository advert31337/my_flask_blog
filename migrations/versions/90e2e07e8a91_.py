...
Revision ID: 90e2e07e8a91
Revises: 3ef8ce85a7af
Create Date: 2019-08-27 00:05:29.561168
...
revision = '90e2e07e8a91'
down_revision = '3ef8ce85a7af'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['news_id'], ['news_test.id'], ondelete='CASCADE'),
